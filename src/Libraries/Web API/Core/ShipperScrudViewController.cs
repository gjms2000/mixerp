...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The ShipperScrudView data context.
        /// </summary>
        private readonly MixERP.Net.Schemas.Core.Data.ShipperScrudView ShipperScrudViewContext;
        ...
        public ShipperScrudViewController()
        {
            ...
            this.ShipperScrudViewContext = new MixERP.Net.Schemas.Core.Data.ShipperScrudView
            {
        ...
        public long Count()
        {
            try
            {
                return this.ShipperScrudViewContext.Count();
            }
        ...
        /// <summary>
        ///     Creates a paginated collection containing 25 shipper scrud views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.ShipperScrudView> GetPagedResult()
        {
            try
            {
                return this.ShipperScrudViewContext.GetPagedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.ShipperScrudView> GetPagedResult(long pageNumber)
        {
            try
            {
                return this.ShipperScrudViewContext.GetPagedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.ShipperScrudViewContext.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]dynamic filters)
        {
            try
            {
                ...
                return this.ShipperScrudViewContext.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 25 shipper scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.ShipperScrudView> GetWhere(long pageNumber, [FromBody]dynamic filters)
        {
            try
            {
                List<EntityParser.Filter> f = JsonConvert.DeserializeObject<List<EntityParser.Filter>>(filters);
                return this.ShipperScrudViewContext.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.ShipperScrudViewContext.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.ShipperScrudView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.ShipperScrudViewContext.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
