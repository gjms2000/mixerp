...
namespace MixERP.Net.Api.Core
{
    ...
    public class CustomFieldDataTypeController : ApiController
    {
        ...
        public void AddOrEdit([FromBody]MixERP.Net.Entities.Core.CustomFieldDataType customFieldDataType)
        {
            ...
            try
            {
                this.CustomFieldDataTypeContext.AddOrEdit(customFieldDataType);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
