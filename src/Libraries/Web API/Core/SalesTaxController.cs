...
namespace MixERP.Net.Api.Core
{
    ...
    public class SalesTaxController : ApiController
    {
        ...
        /// <summary>
        ///     Displayfields is a lightweight key/value collection of sales taxes.
        /// </summary>
        ...
        /// </summary>
        /// <param name="salesTax">Your instance of Account class to edit.</param>
        /// <param name="salesTaxId">Enter the value for SalesTaxId in order to find and edit the existing record.</param>
        [AcceptVerbs("PUT")]
        [Route("edit/{salesTaxId}/{salesTax}")]
        [Route("~/api/core/sales-tax/edit/{salesTaxId}/{salesTax}")]
        public void Edit(int salesTaxId, MixERP.Net.Entities.Core.SalesTax salesTax)
        {
            if (salesTax == null)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.MethodNotAllowed));
        ...
        /// <summary>
        ///     Deletes an existing instance of Account class via SalesTaxId.
        /// </summary>
