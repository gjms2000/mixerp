...
namespace MixERP.Net.Api.Core
{
    ...
    public class CountryController : ApiController
    {
        ...
        public IEnumerable<MixERP.Net.Entities.Core.Country> GetWhere(long pageNumber, [FromBody]dynamic filters)
        {
            try
            {
        ...
        public void AddOrEdit([FromBody]MixERP.Net.Entities.Core.Country country)
        {
            if (country == null)
            {
            ...
            try
            {
                this.CountryContext.AddOrEdit(country);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
