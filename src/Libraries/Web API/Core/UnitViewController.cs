...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The UnitView data context.
        /// </summary>
        private readonly MixERP.Net.Schemas.Core.Data.UnitView UnitViewContext;
        ...
        public UnitViewController()
        {
            ...
            this.UnitViewContext = new MixERP.Net.Schemas.Core.Data.UnitView
            {
        ...
        public long Count()
        {
            try
            {
                return this.UnitViewContext.Count();
            }
        ...
        public IEnumerable<MixERP.Net.Entities.Core.UnitView> GetPagedResult()
        {
            try
            {
                return this.UnitViewContext.GetPagedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.UnitView> GetPagedResult(long pageNumber)
        {
            try
            {
                return this.UnitViewContext.GetPagedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.UnitViewContext.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]dynamic filters)
        {
            try
            {
                ...
                return this.UnitViewContext.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.UnitView> GetWhere(long pageNumber, [FromBody]dynamic filters)
        {
            ...
            {
                List<EntityParser.Filter> f = JsonConvert.DeserializeObject<List<EntityParser.Filter>>(filters);
                return this.UnitViewContext.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.UnitViewContext.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.UnitView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.UnitViewContext.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
