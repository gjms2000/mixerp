...
namespace MixERP.Net.Api.Core
{
    ...
    public class AgeingSlabScrudViewController : ApiController
    {
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.AgeingSlabScrudViewContext.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]dynamic filters)
        {
            try
            {
                ...
                return this.AgeingSlabScrudViewContext.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.AgeingSlabScrudViewContext.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.AgeingSlabScrudView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.AgeingSlabScrudViewContext.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
