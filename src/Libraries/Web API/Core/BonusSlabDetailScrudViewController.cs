...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The BonusSlabDetailScrudView data context.
        /// </summary>
        private readonly MixERP.Net.Schemas.Core.Data.BonusSlabDetailScrudView BonusSlabDetailScrudViewContext;
        ...
        public BonusSlabDetailScrudViewController()
        {
            ...
            this.BonusSlabDetailScrudViewContext = new MixERP.Net.Schemas.Core.Data.BonusSlabDetailScrudView
            {
        ...
        public long Count()
        {
            try
            {
                return this.BonusSlabDetailScrudViewContext.Count();
            }
        ...
        /// <summary>
        ///     Creates a paginated collection containing 25 bonus slab detail scrud views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.BonusSlabDetailScrudView> GetPagedResult()
        {
            try
            {
                return this.BonusSlabDetailScrudViewContext.GetPagedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.BonusSlabDetailScrudView> GetPagedResult(long pageNumber)
        {
            try
            {
                return this.BonusSlabDetailScrudViewContext.GetPagedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.BonusSlabDetailScrudViewContext.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]dynamic filters)
        {
            try
            {
                ...
                return this.BonusSlabDetailScrudViewContext.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 25 bonus slab detail scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.BonusSlabDetailScrudView> GetWhere(long pageNumber, [FromBody]dynamic filters)
        {
            try
            {
                List<EntityParser.Filter> f = JsonConvert.DeserializeObject<List<EntityParser.Filter>>(filters);
                return this.BonusSlabDetailScrudViewContext.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.BonusSlabDetailScrudViewContext.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.BonusSlabDetailScrudView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.BonusSlabDetailScrudViewContext.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
