...
namespace MixERP.Net.Api.Core
{
    ...
    public class ItemGroupController : ApiController
    {
        ...
        /// <summary>
        ///     Displayfields is a lightweight key/value collection of item groups.
        /// </summary>
        ...
        /// </summary>
        /// <param name="itemGroup">Your instance of Account class to edit.</param>
        /// <param name="itemGroupId">Enter the value for ItemGroupId in order to find and edit the existing record.</param>
        [AcceptVerbs("PUT")]
        [Route("edit/{itemGroupId}/{itemGroup}")]
        [Route("~/api/core/item-group/edit/{itemGroupId}/{itemGroup}")]
        public void Edit(int itemGroupId, MixERP.Net.Entities.Core.ItemGroup itemGroup)
        {
            if (itemGroup == null)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.MethodNotAllowed));
        ...
        /// <summary>
        ///     Deletes an existing instance of Account class via ItemGroupId.
        /// </summary>
