...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The SalesTaxDetailScrudView data context.
        /// </summary>
        private readonly MixERP.Net.Schemas.Core.Data.SalesTaxDetailScrudView SalesTaxDetailScrudViewContext;
        ...
        public long Count()
        {
            try
            {
                return this.SalesTaxDetailScrudViewContext.Count();
            }
        ...
        /// <summary>
        ///     Creates a paginated collection containing 25 sales tax detail scrud views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SalesTaxDetailScrudView> GetPagedResult()
        {
            try
            {
                return this.SalesTaxDetailScrudViewContext.GetPagedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SalesTaxDetailScrudView> GetPagedResult(long pageNumber)
        {
            try
            {
                return this.SalesTaxDetailScrudViewContext.GetPagedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.SalesTaxDetailScrudViewContext.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SalesTaxDetailScrudView> GetWhere(long pageNumber, [FromBody]dynamic filters)
        {
            try
            {
