...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The SalespersonScrudView data context.
        /// </summary>
        private readonly MixERP.Net.Schemas.Core.Data.SalespersonScrudView SalespersonScrudViewContext;
        ...
        public SalespersonScrudViewController()
        {
            ...
            this.SalespersonScrudViewContext = new MixERP.Net.Schemas.Core.Data.SalespersonScrudView
            {
        ...
        public long Count()
        {
            try
            {
                return this.SalespersonScrudViewContext.Count();
            }
        ...
        /// <summary>
        ///     Creates a paginated collection containing 25 salesperson scrud views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SalespersonScrudView> GetPagedResult()
        {
            try
            {
                return this.SalespersonScrudViewContext.GetPagedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SalespersonScrudView> GetPagedResult(long pageNumber)
        {
            try
            {
                return this.SalespersonScrudViewContext.GetPagedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.SalespersonScrudViewContext.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]dynamic filters)
        {
            try
            {
                ...
                return this.SalespersonScrudViewContext.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 25 salesperson scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SalespersonScrudView> GetWhere(long pageNumber, [FromBody]dynamic filters)
        {
            try
            {
                List<EntityParser.Filter> f = JsonConvert.DeserializeObject<List<EntityParser.Filter>>(filters);
                return this.SalespersonScrudViewContext.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.SalespersonScrudViewContext.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SalespersonScrudView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.SalespersonScrudViewContext.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
