...
namespace MixERP.Net.Api.Core
{
    ...
    {
        /// <summary>
        ///     The CashFlowHeadingScrudView data context.
        /// </summary>
        private readonly MixERP.Net.Schemas.Core.Data.CashFlowHeadingScrudView CashFlowHeadingScrudViewContext;
        ...
        public CashFlowHeadingScrudViewController()
        {
            ...
            this.CashFlowHeadingScrudViewContext = new MixERP.Net.Schemas.Core.Data.CashFlowHeadingScrudView
            {
        ...
        public long Count()
        {
            try
            {
                return this.CashFlowHeadingScrudViewContext.Count();
            }
        ...
        /// <summary>
        ///     Creates a paginated collection containing 25 cash flow heading scrud views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.CashFlowHeadingScrudView> GetPagedResult()
        {
            try
            {
                return this.CashFlowHeadingScrudViewContext.GetPagedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.CashFlowHeadingScrudView> GetPagedResult(long pageNumber)
        {
            try
            {
                return this.CashFlowHeadingScrudViewContext.GetPagedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<DisplayField> GetDisplayFields()
        {
            try
            {
                return this.CashFlowHeadingScrudViewContext.GetDisplayFields();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountWhere([FromBody]dynamic filters)
        {
            try
            {
                ...
                return this.CashFlowHeadingScrudViewContext.CountWhere(f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 25 cash flow heading scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.CashFlowHeadingScrudView> GetWhere(long pageNumber, [FromBody]dynamic filters)
        {
            try
            {
                List<EntityParser.Filter> f = JsonConvert.DeserializeObject<List<EntityParser.Filter>>(filters);
                return this.CashFlowHeadingScrudViewContext.GetWhere(pageNumber, f);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public long CountFiltered(string filterName)
        {
            try
            {
                return this.CashFlowHeadingScrudViewContext.CountFiltered(filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.CashFlowHeadingScrudView> GetFiltered(long pageNumber, string filterName)
        {
            try
            {
                return this.CashFlowHeadingScrudViewContext.GetFiltered(pageNumber, filterName);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
