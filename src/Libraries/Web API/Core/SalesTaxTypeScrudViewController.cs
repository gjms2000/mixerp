...
namespace MixERP.Net.Api.Core
{
    ...
    public class SalesTaxTypeScrudViewController : ApiController
    {
        ...
        /// <summary>
        ///     Creates a paginated collection containing 25 sales tax type scrud views on each page, sorted by the property .
        /// </summary>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SalesTaxTypeScrudView> GetPagedResult()
        {
            try
            {
                return this.SalesTaxTypeScrudViewContext.GetPagedResult();
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SalesTaxTypeScrudView> GetPagedResult(long pageNumber)
        {
            try
            {
                return this.SalesTaxTypeScrudViewContext.GetPagedResult(pageNumber);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 25 sales tax type scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.SalesTaxTypeScrudView> GetWhere(long pageNumber, [FromBody]dynamic filters)
        {
            try
            {
