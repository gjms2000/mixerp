...
namespace MixERP.Net.Api.Core
{
    ...
    public class CustomFieldViewController : ApiController
    {
        ...
        /// <summary>
        ///     Creates a paginated collection containing 25 custom field views on each page, sorted by the property .
        /// </summary>
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 25 custom field views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Core.CustomFieldView> GetWhere(long pageNumber, [FromBody]dynamic filters)
        {
            try
            {
