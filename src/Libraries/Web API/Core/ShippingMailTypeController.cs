...
namespace MixERP.Net.Api.Core
{
    ...
    public class ShippingMailTypeController : ApiController
    {
        ...
        public IEnumerable<MixERP.Net.Entities.Core.ShippingMailType> GetWhere(long pageNumber, [FromBody]dynamic filters)
        {
            try
            {
        ...
        public void AddOrEdit([FromBody]MixERP.Net.Entities.Core.ShippingMailType shippingMailType)
        {
            ...
            try
            {
                this.ShippingMailTypeContext.AddOrEdit(shippingMailType);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
