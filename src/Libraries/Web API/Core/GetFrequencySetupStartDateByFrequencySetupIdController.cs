...
namespace MixERP.Net.Api.Core
{
    ...
    public class GetFrequencySetupStartDateByFrequencySetupIdController : ApiController
    {
        ...
        private GetFrequencySetupStartDateByFrequencySetupIdProcedure procedure;
        ...
        public GetFrequencySetupStartDateByFrequencySetupIdController()
        {
            ...
            this.procedure = new GetFrequencySetupStartDateByFrequencySetupIdProcedure
            {
        ...
        public DateTime Execute([FromBody] Annotation annotation)
        {
            try
            {
                this.procedure.FrequencySetupId = annotation.FrequencySetupId;
