...
namespace MixERP.Net.Api.Office
{
    ...
    public class CashRepositorySelectorViewController : ApiController
    {
        ...
        /// <summary>
        ///     Creates a paginated collection containing 25 cash repository selector views on each page, sorted by the property .
        /// </summary>
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 25 cash repository selector views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Office.CashRepositorySelectorView> GetWhere(long pageNumber, [FromBody]dynamic filters)
        {
            try
            {
