...
namespace MixERP.Net.Api.Office
{
    ...
    public class GetCostCenterIdByCostCenterCodeController : ApiController
    {
        ...
        private GetCostCenterIdByCostCenterCodeProcedure procedure;
        ...
        public GetCostCenterIdByCostCenterCodeController()
        {
            ...
            this.procedure = new GetCostCenterIdByCostCenterCodeProcedure
            {
        ...
        public int Execute([FromBody] Annotation annotation)
        {
            try
            {
                this.procedure.CostCenterCode = annotation.CostCenterCode;
