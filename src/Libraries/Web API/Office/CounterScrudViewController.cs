...
namespace MixERP.Net.Api.Office
{
    ...
    public class CounterScrudViewController : ApiController
    {
        ...
        /// <summary>
        ///     Creates a paginated collection containing 25 counter scrud views on each page, sorted by the property .
        /// </summary>
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 25 counter scrud views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Office.CounterScrudView> GetWhere(long pageNumber, [FromBody]dynamic filters)
        {
            try
            {
                List<EntityParser.Filter> f = JsonConvert.DeserializeObject<List<EntityParser.Filter>>(filters);
