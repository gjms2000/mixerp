...
namespace MixERP.Net.Api.Transactions
{
    ...
    public class SalesDeliveryViewController : ApiController
    {
        ...
        /// <summary>
        ///     Creates a paginated collection containing 25 sales delivery views on each page, sorted by the property .
        /// </summary>
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 25 sales delivery views on each page, sorted by the property .
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.Transactions.SalesDeliveryView> GetWhere(long pageNumber, [FromBody]dynamic filters)
        {
            try
            {
