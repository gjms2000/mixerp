...
namespace MixERP.Net.Api.Transactions
{
    ...
    public class InventoryTransferRequestController : ApiController
    {
        ...
        /// <summary>
        ///     Displayfields is a lightweight key/value collection of inventory transfer requests.
        /// </summary>
        ...
        /// </summary>
        /// <param name="inventoryTransferRequest">Your instance of Account class to edit.</param>
        ...
        /// <summary>
        ///     Deletes an existing instance of Account class via InventoryTransferRequestId.
        /// </summary>
