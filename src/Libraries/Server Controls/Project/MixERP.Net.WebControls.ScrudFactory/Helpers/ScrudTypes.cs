...
namespace MixERP.Net.WebControls.ScrudFactory.Helpers
{
    public static class ScrudTypes
    {
        ...
        public static readonly string[] Strings = {"national character varying", "character varying", "national character", "character", "char", "varchar", "nvarchar", "text", "Text", "Long Text", "color", "transaction_type"};
