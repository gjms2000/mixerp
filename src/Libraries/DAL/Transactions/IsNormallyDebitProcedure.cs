...
namespace MixERP.Net.Schemas.Transactions.Data
{
	...
	public class IsNormallyDebitProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "is_normally_debit";
        /// <summary>
		...
		public bool Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"IsNormallyDebitProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
