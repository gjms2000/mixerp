...
namespace MixERP.Net.Schemas.Transactions.Data
{
    ...
    public class InventoryTransferRequestDetail : DbAccess
    {
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
		public void AddOrEdit(MixERP.Net.Entities.Transactions.InventoryTransferRequestDetail inventoryTransferRequestDetail)
		{
			if(string.IsNullOrWhiteSpace(this.Catalog))
			{
				return;
			...
			this.Add(inventoryTransferRequestDetail);
		}
