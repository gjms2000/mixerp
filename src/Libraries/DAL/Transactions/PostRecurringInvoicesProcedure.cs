...
namespace MixERP.Net.Schemas.Transactions.Data
{
	...
	/// </summary>
	public class PostRecurringInvoicesProcedure: DbAccess
	{
        /// <summary>
		...
		public void Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"PostRecurringInvoicesProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
