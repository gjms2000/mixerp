...
namespace MixERP.Net.Schemas.Transactions.Data
{
	...
	public class PostStockJournalProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "post_stock_journal";
        /// <summary>
		...
		public long Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"PostStockJournalProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
