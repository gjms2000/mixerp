...
namespace MixERP.Net.Schemas.Transactions.Data
{
    ...
    public class StockDetail : DbAccess
    {
        ...
        /// <summary>
        /// Performs a select statement on table "transactions.stock_details" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "transactions.stock_details" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "StockDetail" class.</returns>
