...
namespace MixERP.Net.Schemas.Transactions.Data
{
	...
	public class GetNewTransactionCounterProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "get_new_transaction_counter";
        /// <summary>
		...
		public int Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetNewTransactionCounterProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
