...
{
    /// <summary>
    /// Provides simplified data access features to perform SCRUD operation on the database table "transactions.party_item_chart_view".
    /// </summary>
    public class PartyItemChartView : DbAccess
    {
        ...
        /// <summary>
        /// The schema unqualified name of this table. Returns literal "party_item_chart_view".
        /// </summary>
        ...
        /// <summary>
		/// Performs a filtered select statement on table "transactions.party_item_chart_view" producing a paged result of 25.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
