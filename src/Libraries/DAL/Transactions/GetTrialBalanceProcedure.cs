...
namespace MixERP.Net.Schemas.Transactions.Data
{
    ...
    public class GetTrialBalanceProcedure : DbAccess
    {
        ...
        public IEnumerable<DbGetTrialBalanceResult> Execute()
        {
            ...
            return Factory.Get<DbGetTrialBalanceResult>(this._Catalog, query, this.DateFrom, this.DateTo, this.UserId, this.OfficeId, this.Compact, this.Factor, this.ChangeSideWhenNegative, this.IncludeZeroBalanceAccounts);
        }
    }
}