...
namespace MixERP.Net.Schemas.Transactions.Data
{
	...
	/// </summary>
	public class PostSalesReturnProcedure: DbAccess
	{
        /// <summary>
		...
		public long Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"PostSalesReturnProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
