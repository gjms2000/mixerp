...
namespace MixERP.Net.Schemas.Transactions.Data
{
    ...
    public class DayOperationRoutine : DbAccess
    {
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public object AddOrEdit(MixERP.Net.Entities.Transactions.DayOperationRoutine dayOperationRoutine, List<EntityParser.CustomField> customFields)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
        ...
        public object Add(MixERP.Net.Entities.Transactions.DayOperationRoutine dayOperationRoutine)
        {
            ...
            return Factory.Insert(this._Catalog, dayOperationRoutine);
        }
        ...
        public void Update(MixERP.Net.Entities.Transactions.DayOperationRoutine dayOperationRoutine, long dayOperationRoutineId)
        {
            ...
            Factory.Update(this._Catalog, dayOperationRoutine, dayOperationRoutineId);
        }
        ...
        /// <summary>
        /// Performs a select statement on table "transactions.day_operation_routines" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "transactions.day_operation_routines" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "DayOperationRoutine" class.</returns>
