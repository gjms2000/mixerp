...
namespace MixERP.Net.Schemas.Transactions.Data
{
	...
	/// </summary>
	public class AreSalesOrdersAlreadyMergedProcedure: DbAccess
	{
        /// <summary>
        ...
        /// </summary>
	    public override string ObjectName => "are_sales_orders_already_merged";
        /// <summary>
		...
		public bool Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"AreSalesOrdersAlreadyMergedProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM transactions.are_sales_orders_already_merged(@0::bigint[]);";
