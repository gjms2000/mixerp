...
namespace MixERP.Net.Schemas.Transactions.Data
{
	...
	public class GetStockMasterIdByTransactionMasterIdProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "get_stock_master_id_by_transaction_master_id";
        /// <summary>
		...
		public long Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetStockMasterIdByTransactionMasterIdProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM transactions.get_stock_master_id_by_transaction_master_id(@0::bigint);";
