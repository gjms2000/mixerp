...
namespace MixERP.Net.Schemas.Transactions.Data
{
	...
	public class GetNetProfitProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "get_net_profit";
        /// <summary>
		...
		public decimal Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetNetProfitProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM transactions.get_net_profit(@0::date, @1::date, @2::integer, @3::integer, @4::boolean);";
			return Factory.Scalar<decimal>(this.Catalog, query, this.DateFrom, this.DateTo, this.OfficeId, this.Factor, this.NoProvison);
		} 
	}
}