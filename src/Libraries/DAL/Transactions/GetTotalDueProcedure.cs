...
namespace MixERP.Net.Schemas.Transactions.Data
{
	...
	public class GetTotalDueProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "get_total_due";
        /// <summary>
		...
		public decimal Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetTotalDueProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM transactions.get_total_due(@0::integer, @1::bigint);";
			return Factory.Scalar<decimal>(this.Catalog, query, this.OfficeId, this.PartyId);
		} 
	}
}