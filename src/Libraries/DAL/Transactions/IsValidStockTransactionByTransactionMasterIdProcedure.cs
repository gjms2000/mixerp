...
namespace MixERP.Net.Schemas.Transactions.Data
{
	...
	public class IsValidStockTransactionByTransactionMasterIdProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "is_valid_stock_transaction_by_transaction_master_id";
        /// <summary>
		...
		public bool Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"IsValidStockTransactionByTransactionMasterIdProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM transactions.is_valid_stock_transaction_by_transaction_master_id(@0::bigint);";
