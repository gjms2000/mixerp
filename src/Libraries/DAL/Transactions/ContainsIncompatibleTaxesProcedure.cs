...
namespace MixERP.Net.Schemas.Transactions.Data
{
	...
	public class ContainsIncompatibleTaxesProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "contains_incompatible_taxes";
        /// <summary>
		...
		public bool Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"ContainsIncompatibleTaxesProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
