...
namespace MixERP.Net.Schemas.Transactions.Data
{
	...
	public class GetValueDateProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "get_value_date";
        /// <summary>
		...
		public DateTime Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetValueDateProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM transactions.get_value_date(@0::integer);";
