...
namespace MixERP.Net.Schemas.Transactions.Data
{
    ...
    public class SalesQuotationView : DbAccess
    {
        ...
        /// <summary>
        /// Performs a select statement on the view "transactions.sales_quotation_view" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on view "transactions.sales_quotation_view" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "SalesQuotationView" class.</returns>
