...
namespace MixERP.Net.Schemas.Transactions.Data
{
	...
	public class IsValidPartyByStockMasterIdProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "is_valid_party_by_stock_master_id";
        /// <summary>
		...
		public bool Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"IsValidPartyByStockMasterIdProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM transactions.is_valid_party_by_stock_master_id(@0::bigint, @1::bigint);";
			return Factory.Scalar<bool>(this.Catalog, query, this.StockMasterId, this.PartyId);
		} 
	}
}