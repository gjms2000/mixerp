...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class SalesTax : DbAccess
    {
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public object AddOrEdit(MixERP.Net.Entities.Core.SalesTax salesTax, List<EntityParser.CustomField> customFields)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
            ...
            salesTax.AuditUserId = this._UserId;
        ...
        public object Add(MixERP.Net.Entities.Core.SalesTax salesTax)
        {
            ...
            return Factory.Insert(this._Catalog, salesTax);
        }
        ...
        public void Update(MixERP.Net.Entities.Core.SalesTax salesTax, int salesTaxId)
        {
            ...
            Factory.Update(this._Catalog, salesTax, salesTaxId);
        }
        ...
        /// <summary>
        /// Performs a select statement on table "core.sales_taxes" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "core.sales_taxes" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "SalesTax" class.</returns>
