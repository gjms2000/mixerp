...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class SalesTaxType : DbAccess
    {
        ...
        public IEnumerable<PetaPoco.CustomField> GetCustomFields()
        {
            ...
            const string sql = "SELECT * FROM core.custom_field_definition_view WHERE table_name='core.sales_tax_types' ORDER BY field_order;";
		...
		public void Add(MixERP.Net.Entities.Core.SalesTaxType salesTaxType)
		{
			...
			Factory.Insert(this.Catalog, salesTaxType);
		}
