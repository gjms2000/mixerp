...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	public class HasChildAccountsProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "has_child_accounts";
        /// <summary>
		...
		public bool Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"HasChildAccountsProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM core.has_child_accounts(@0::bigint);";
