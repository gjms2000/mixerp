...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class LateFee : DbAccess
    {
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public object AddOrEdit(MixERP.Net.Entities.Core.LateFee lateFee, List<EntityParser.CustomField> customFields)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
            ...
            lateFee.AuditUserId = this._UserId;
        ...
        public void Update(MixERP.Net.Entities.Core.LateFee lateFee, int lateFeeId)
        {
            ...
            Factory.Update(this._Catalog, lateFee, lateFeeId);
        }
        ...
        /// <summary>
        /// Performs a select statement on table "core.late_fee" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "core.late_fee" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "LateFee" class.</returns>
