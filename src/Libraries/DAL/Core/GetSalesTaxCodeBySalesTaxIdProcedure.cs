...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	/// </summary>
	public class GetSalesTaxCodeBySalesTaxIdProcedure: DbAccess
	{
        /// <summary>
        ...
        /// </summary>
	    public override string ObjectName => "get_sales_tax_code_by_sales_tax_id";
        /// <summary>
		...
		public string Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetSalesTaxCodeBySalesTaxIdProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM core.get_sales_tax_code_by_sales_tax_id(@0::integer);";
