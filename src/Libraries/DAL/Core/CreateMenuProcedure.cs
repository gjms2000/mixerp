...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	public class CreateMenuProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "create_menu";
        /// <summary>
		...
		public void Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"CreateMenuProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
