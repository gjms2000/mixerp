...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class CashFlowSetup : DbAccess
    {
        ...
        public IEnumerable<PetaPoco.CustomField> GetCustomFields()
        {
            ...
            const string sql = "SELECT * FROM core.custom_field_definition_view WHERE table_name='core.cash_flow_setup' ORDER BY field_order;";
		...
		public void Add(MixERP.Net.Entities.Core.CashFlowSetup cashFlowSetup)
		{
			...
			Factory.Insert(this.Catalog, cashFlowSetup);
		}
