...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class AccountMaster : DbAccess
    {
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public object AddOrEdit(MixERP.Net.Entities.Core.AccountMaster accountMaster, List<EntityParser.CustomField> customFields)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
        ...
        public object Add(MixERP.Net.Entities.Core.AccountMaster accountMaster)
        {
            ...
            return Factory.Insert(this._Catalog, accountMaster);
        }
        ...
        public void Update(MixERP.Net.Entities.Core.AccountMaster accountMaster, short accountMasterId)
        {
            ...
            Factory.Update(this._Catalog, accountMaster, accountMasterId);
        }
        ...
        /// <summary>
        /// Performs a select statement on table "core.account_masters" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "core.account_masters" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "AccountMaster" class.</returns>
