...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	public class GetFrequencyEndDateProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "get_frequency_end_date";
        /// <summary>
		...
		public DateTime Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetFrequencyEndDateProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
