...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	/// </summary>
	public class GetFlagForegroundColorProcedure: DbAccess
	{
        /// <summary>
        ...
        /// </summary>
	    public override string ObjectName => "get_flag_foreground_color";
        /// <summary>
		...
		public string Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetFlagForegroundColorProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM core.get_flag_foreground_color(@0::integer);";
