...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	/// </summary>
	public class GetFrequencySetupStartDateByFrequencySetupIdProcedure: DbAccess
	{
        /// <summary>
        ...
        /// </summary>
	    public override string ObjectName => "get_frequency_setup_start_date_by_frequency_setup_id";
        /// <summary>
		...
		public DateTime Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetFrequencySetupStartDateByFrequencySetupIdProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM core.get_frequency_setup_start_date_by_frequency_setup_id(@0::integer);";
			return Factory.Scalar<DateTime>(this.Catalog, query, this.FrequencySetupId);
		} 
	}
}