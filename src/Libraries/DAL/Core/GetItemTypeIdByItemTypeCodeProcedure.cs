...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	/// </summary>
	public class GetItemTypeIdByItemTypeCodeProcedure: DbAccess
	{
        /// <summary>
        ...
        /// </summary>
	    public override string ObjectName => "get_item_type_id_by_item_type_code";
        /// <summary>
		...
		public int Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetItemTypeIdByItemTypeCodeProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM core.get_item_type_id_by_item_type_code(@0::text);";
