...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	public class GetBrandIdByBrandCodeProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "get_brand_id_by_brand_code";
        /// <summary>
		...
		public int Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetBrandIdByBrandCodeProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
