...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	public class GetAccountNameProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "get_account_name";
        /// <summary>
		...
		public string Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetAccountNameProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM core.get_account_name(@0::bigint);";
