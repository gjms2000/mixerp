...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class TaxMaster : DbAccess
    {
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public object AddOrEdit(MixERP.Net.Entities.Core.TaxMaster taxMaster, List<EntityParser.CustomField> customFields)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
            ...
            taxMaster.AuditUserId = this._UserId;
        ...
        public object Add(MixERP.Net.Entities.Core.TaxMaster taxMaster)
        {
            ...
            return Factory.Insert(this._Catalog, taxMaster);
        }
        ...
        public void Update(MixERP.Net.Entities.Core.TaxMaster taxMaster, int taxMasterId)
        {
            ...
            Factory.Update(this._Catalog, taxMaster, taxMasterId);
        }
        ...
        /// <summary>
        /// Performs a select statement on table "core.tax_master" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "core.tax_master" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "TaxMaster" class.</returns>
