...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	public class IsValidUnitIdProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "is_valid_unit_id";
        /// <summary>
		...
		public bool Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"IsValidUnitIdProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
