...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	/// </summary>
	public class GetAccountMasterIdByAccountIdProcedure: DbAccess
	{
        /// <summary>
        ...
        /// </summary>
	    public override string ObjectName => "get_account_master_id_by_account_id";
        /// <summary>
		...
		public int Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetAccountMasterIdByAccountIdProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM core.get_account_master_id_by_account_id(@0::bigint);";
			return Factory.Scalar<int>(this.Catalog, query, this.AccountId);
		} 
	}
}