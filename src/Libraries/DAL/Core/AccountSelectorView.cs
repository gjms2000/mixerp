...
{
    /// <summary>
    /// Provides simplified data access features to perform SCRUD operation on the database table "core.account_selector_view".
    /// </summary>
    public class AccountSelectorView : DbAccess
    {
        ...
        /// <summary>
        /// The schema unqualified name of this table. Returns literal "account_selector_view".
        /// </summary>
        ...
        /// <summary>
		/// Performs a filtered select statement on table "core.account_selector_view" producing a paged result of 25.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
