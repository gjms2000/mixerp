...
{
    /// <summary>
    /// Provides simplified data access features to perform SCRUD operation on the database table "core.custom_field_view".
    /// </summary>
    public class CustomFieldView : DbAccess
    {
        ...
        /// <summary>
        /// The schema unqualified name of this table. Returns literal "custom_field_view".
        /// </summary>
		...
		/// <summary>
		/// Performs SQL count on the table "core.custom_field_view".
		/// </summary>
		/// <returns>Returns the number of rows of the table "core.custom_field_view".</returns>
		...
		/// <summary>
		/// Performs a select statement on table "core.custom_field_view" producing a paged result of 25.
		/// </summary>
        ...
        /// <summary>
		/// Performs a filtered select statement on table "core.custom_field_view" producing a paged result of 25.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
