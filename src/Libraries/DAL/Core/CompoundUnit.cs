...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class CompoundUnit : DbAccess
    {
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public object AddOrEdit(MixERP.Net.Entities.Core.CompoundUnit compoundUnit, List<EntityParser.CustomField> customFields)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
            ...
            compoundUnit.AuditUserId = this._UserId;
        ...
        public object Add(MixERP.Net.Entities.Core.CompoundUnit compoundUnit)
        {
            ...
            return Factory.Insert(this._Catalog, compoundUnit);
        }
        ...
        public void Update(MixERP.Net.Entities.Core.CompoundUnit compoundUnit, int compoundUnitId)
        {
            ...
            Factory.Update(this._Catalog, compoundUnit, compoundUnitId);
        }
        ...
        /// <summary>
        /// Performs a select statement on table "core.compound_units" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "core.compound_units" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "CompoundUnit" class.</returns>
