...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	public class GetCashFlowHeadingIdByCashFlowHeadingCodeProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "get_cash_flow_heading_id_by_cash_flow_heading_code";
        /// <summary>
		...
		public int Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetCashFlowHeadingIdByCashFlowHeadingCodeProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM core.get_cash_flow_heading_id_by_cash_flow_heading_code(@0::character varying);";
			return Factory.Scalar<int>(this.Catalog, query, this.CashFlowHeadingCode);
		} 
	}
}