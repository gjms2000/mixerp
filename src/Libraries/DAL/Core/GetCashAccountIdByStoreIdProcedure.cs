...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	/// </summary>
	public class GetCashAccountIdByStoreIdProcedure: DbAccess
	{
        /// <summary>
        ...
        /// </summary>
	    public override string ObjectName => "get_cash_account_id_by_store_id";
        /// <summary>
		...
		public long Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetCashAccountIdByStoreIdProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM core.get_cash_account_id_by_store_id(@0::integer);";
			return Factory.Scalar<long>(this.Catalog, query, this.StoreId);
		} 
	}
}