...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class County : DbAccess
    {
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public object AddOrEdit(MixERP.Net.Entities.Core.County county, List<EntityParser.CustomField> customFields)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
            ...
            county.AuditUserId = this._UserId;
        ...
        public object Add(MixERP.Net.Entities.Core.County county)
        {
            ...
            return Factory.Insert(this._Catalog, county);
        }
        ...
        public void Update(MixERP.Net.Entities.Core.County county, int countyId)
        {
            ...
            Factory.Update(this._Catalog, county, countyId);
        }
        ...
        /// <summary>
        /// Performs a select statement on table "core.counties" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "core.counties" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "County" class.</returns>
