...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	/// </summary>
	public class GetMenuIdByMenuCodeProcedure: DbAccess
	{
        /// <summary>
        ...
        /// </summary>
	    public override string ObjectName => "get_menu_id_by_menu_code";
        /// <summary>
		...
		public int Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetMenuIdByMenuCodeProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM core.get_menu_id_by_menu_code(@0::character varying);";
