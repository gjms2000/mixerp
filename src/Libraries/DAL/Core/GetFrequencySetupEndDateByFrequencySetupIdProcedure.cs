...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	public class GetFrequencySetupEndDateByFrequencySetupIdProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "get_frequency_setup_end_date_by_frequency_setup_id";
        /// <summary>
		...
		public DateTime Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetFrequencySetupEndDateByFrequencySetupIdProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
