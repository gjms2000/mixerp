...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class BonusSlabDetail : DbAccess
    {
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public object AddOrEdit(MixERP.Net.Entities.Core.BonusSlabDetail bonusSlabDetail, List<EntityParser.CustomField> customFields)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
            ...
            bonusSlabDetail.AuditUserId = this._UserId;
        ...
        public object Add(MixERP.Net.Entities.Core.BonusSlabDetail bonusSlabDetail)
        {
            ...
            return Factory.Insert(this._Catalog, bonusSlabDetail);
        }
        ...
        public void Update(MixERP.Net.Entities.Core.BonusSlabDetail bonusSlabDetail, int bonusSlabDetailId)
        {
            ...
            Factory.Update(this._Catalog, bonusSlabDetail, bonusSlabDetailId);
        }
        ...
        /// <summary>
        /// Performs a select statement on table "core.bonus_slab_details" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "core.bonus_slab_details" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "BonusSlabDetail" class.</returns>
