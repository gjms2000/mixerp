...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class Brand : DbAccess
    {
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public object AddOrEdit(MixERP.Net.Entities.Core.Brand brand, List<EntityParser.CustomField> customFields)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
            ...
            brand.AuditUserId = this._UserId;
        ...
        public object Add(MixERP.Net.Entities.Core.Brand brand)
        {
            ...
            return Factory.Insert(this._Catalog, brand);
        }
        ...
        public void Update(MixERP.Net.Entities.Core.Brand brand, int brandId)
        {
            ...
            Factory.Update(this._Catalog, brand, brandId);
        }
        ...
        /// <summary>
        /// Performs a select statement on table "core.brands" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "core.brands" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "Brand" class.</returns>
