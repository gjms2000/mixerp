...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	/// </summary>
	public class GetCountryIdByCountryCodeProcedure: DbAccess
	{
        /// <summary>
        ...
        /// </summary>
	    public override string ObjectName => "get_country_id_by_country_code";
        /// <summary>
		...
		public int Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetCountryIdByCountryCodeProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM core.get_country_id_by_country_code(@0::character varying);";
			return Factory.Scalar<int>(this.Catalog, query, this.CountryCode);
		} 
	}
}