...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class ZipCodeType : DbAccess
    {
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public object AddOrEdit(MixERP.Net.Entities.Core.ZipCodeType zipCodeType, List<EntityParser.CustomField> customFields)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
            ...
            zipCodeType.AuditUserId = this._UserId;
        ...
        public object Add(MixERP.Net.Entities.Core.ZipCodeType zipCodeType)
        {
            ...
            return Factory.Insert(this._Catalog, zipCodeType);
        }
        ...
        public void Update(MixERP.Net.Entities.Core.ZipCodeType zipCodeType, int zipCodeTypeId)
        {
            ...
            Factory.Update(this._Catalog, zipCodeType, zipCodeTypeId);
        }
        ...
        /// <summary>
        /// Performs a select statement on table "core.zip_code_types" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "core.zip_code_types" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "ZipCodeType" class.</returns>
