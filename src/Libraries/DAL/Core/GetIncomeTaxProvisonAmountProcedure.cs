...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	public class GetIncomeTaxProvisonAmountProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "get_income_tax_provison_amount";
        /// <summary>
		...
		public decimal Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetIncomeTaxProvisonAmountProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM core.get_income_tax_provison_amount(@0::integer, @1::numeric, @2::numeric);";
			return Factory.Scalar<decimal>(this.Catalog, query, this.OfficeId, this.Profit, this.Balance);
		} 
	}
}