...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	public class GetPriceTypeNameByPriceTypeIdProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "get_price_type_name_by_price_type_id";
        /// <summary>
		...
		public string Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetPriceTypeNameByPriceTypeIdProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
