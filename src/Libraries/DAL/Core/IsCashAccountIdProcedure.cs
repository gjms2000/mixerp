...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	public class IsCashAccountIdProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "is_cash_account_id";
        /// <summary>
		...
		public bool Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"IsCashAccountIdProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
