...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	/// </summary>
	public class GetCurrencyCodeByPartyCodeProcedure: DbAccess
	{
        /// <summary>
        ...
        /// </summary>
	    public override string ObjectName => "get_currency_code_by_party_code";
        /// <summary>
		...
		public string Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetCurrencyCodeByPartyCodeProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM core.get_currency_code_by_party_code(@0::character varying);";
			return Factory.Scalar<string>(this.Catalog, query, this.PartyCode);
		} 
	}
}