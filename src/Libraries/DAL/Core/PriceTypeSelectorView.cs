...
{
    public class PriceTypeSelectorView
    {
		/// <summary>
		...
		public IEnumerable<MixERP.Net.Entities.Core.PriceTypeSelectorView> GetPagedResult(string catalog)
		{
			const string sql = "SELECT * FROM core.price_type_selector_view ORDER BY  LIMIT 25 OFFSET 0;";
			return Factory.Get<MixERP.Net.Entities.Core.PriceTypeSelectorView>(catalog, sql);
		}
		...
		public IEnumerable<MixERP.Net.Entities.Core.PriceTypeSelectorView> GetPagedResult(string catalog, long pageNumber)
		{
			long offset = (pageNumber -1) * 25;
			const string sql = "SELECT * FROM core.price_type_selector_view ORDER BY  LIMIT 25 OFFSET @0;";
				
			return Factory.Get<MixERP.Net.Entities.Core.PriceTypeSelectorView>(catalog, sql, offset);
		}
	}
}