...
namespace MixERP.Net.Schemas.Core.Data
{
    ...
    public class PaymentCard : DbAccess
    {
        ...
        /// <summary>
        /// Performs a select statement on table "core.payment_cards" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "core.payment_cards" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "PaymentCard" class.</returns>
