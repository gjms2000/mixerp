...
namespace MixERP.Net.Schemas.Core.Data
{
	...
	public class GetMonthStartDateProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "get_month_start_date";
        /// <summary>
		...
		public DateTime Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetMonthStartDateProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
