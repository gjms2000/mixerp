...
namespace MixERP.Net.Schemas.Config.Data
{
    ...
    public class ScrudFactory : DbAccess
    {
        ...
        /// <summary>
        /// Performs a select statement on table "config.scrud_factory" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "config.scrud_factory" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "ScrudFactory" class.</returns>
