...
{
    public class LocalizedResourceView
    {
		/// <summary>
		...
		public IEnumerable<MixERP.Net.Entities.Localization.LocalizedResourceView> GetPagedResult(string catalog)
		{
			const string sql = "SELECT * FROM localization.localized_resource_view ORDER BY  LIMIT 25 OFFSET 0;";
			return Factory.Get<MixERP.Net.Entities.Localization.LocalizedResourceView>(catalog, sql);
		}
		...
		public IEnumerable<MixERP.Net.Entities.Localization.LocalizedResourceView> GetPagedResult(string catalog, long pageNumber)
		{
			long offset = (pageNumber -1) * 25;
			const string sql = "SELECT * FROM localization.localized_resource_view ORDER BY  LIMIT 25 OFFSET @0;";
				
			return Factory.Get<MixERP.Net.Entities.Localization.LocalizedResourceView>(catalog, sql, offset);
		}
	}
}