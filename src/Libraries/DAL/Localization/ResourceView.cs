...
namespace MixERP.Net.Schemas.Localization.Data
{
    ...
    public class ResourceView : DbAccess
    {
        ...
        /// <summary>
        /// Performs a select statement on the view "localization.resource_view" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on view "localization.resource_view" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "ResourceView" class.</returns>
