...
namespace MixERP.Net.Schemas.Localization.Data
{
    ...
    public class LocalizedResource : DbAccess
    {
        ...
        /// <summary>
        /// Performs a select statement on table "localization.localized_resources" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "localization.localized_resources" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "LocalizedResource" class.</returns>
