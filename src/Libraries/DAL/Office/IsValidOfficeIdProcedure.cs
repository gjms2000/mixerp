...
namespace MixERP.Net.Schemas.Office.Data
{
	...
	public class IsValidOfficeIdProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "is_valid_office_id";
        /// <summary>
		...
		public bool Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"IsValidOfficeIdProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM office.is_valid_office_id(@0::integer);";
