...
namespace MixERP.Net.Schemas.Office.Data
{
    ...
    public class User : DbAccess
    {
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public object AddOrEdit(MixERP.Net.Entities.Office.User user, List<EntityParser.CustomField> customFields)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
        ...
        public object Add(MixERP.Net.Entities.Office.User user)
        {
            ...
            return Factory.Insert(this._Catalog, user);
        }
        ...
        public void Update(MixERP.Net.Entities.Office.User user, int userId)
        {
            ...
            Factory.Update(this._Catalog, user, userId);
        }
        ...
        /// <summary>
        /// Performs a select statement on table "office.users" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "office.users" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "User" class.</returns>
