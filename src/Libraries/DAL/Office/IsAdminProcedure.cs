...
namespace MixERP.Net.Schemas.Office.Data
{
	...
	public class IsAdminProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "is_admin";
        /// <summary>
		...
		public bool Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"IsAdminProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM office.is_admin(@0::integer);";
