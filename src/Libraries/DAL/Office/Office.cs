...
namespace MixERP.Net.Schemas.Office.Data
{
    ...
    public class Office : DbAccess
    {
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public object AddOrEdit(MixERP.Net.Entities.Office.Office office, List<EntityParser.CustomField> customFields)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
            ...
            office.AuditUserId = this._UserId;
        ...
        public object Add(MixERP.Net.Entities.Office.Office office)
        {
            ...
            return Factory.Insert(this._Catalog, office);
        }
        ...
        public void Update(MixERP.Net.Entities.Office.Office office, int officeId)
        {
            ...
            Factory.Update(this._Catalog, office, officeId);
        }
        ...
        /// <summary>
        /// Performs a select statement on table "office.offices" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "office.offices" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "Office" class.</returns>
