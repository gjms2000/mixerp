...
namespace MixERP.Net.Schemas.Office.Data
{
	...
	public class GetLoggedInCultureProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "get_logged_in_culture";
        /// <summary>
		...
		public string Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetLoggedInCultureProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM office.get_logged_in_culture(@0::integer);";
