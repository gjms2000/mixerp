...
namespace MixERP.Net.Schemas.Office.Data
{
    ...
    public class RoleView : DbAccess
    {
        ...
        /// <summary>
        /// Performs a select statement on the view "office.role_view" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on view "office.role_view" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "RoleView" class.</returns>
