...
namespace MixERP.Net.Schemas.Office.Data
{
	...
	/// </summary>
	public class GetRoleIdByRoleCodeProcedure: DbAccess
	{
        /// <summary>
        ...
        /// </summary>
	    public override string ObjectName => "get_role_id_by_role_code";
        /// <summary>
		...
		public int Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetRoleIdByRoleCodeProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM office.get_role_id_by_role_code(@0::text);";
			return Factory.Scalar<int>(this.Catalog, query, this.RoleCode);
		} 
	}
}