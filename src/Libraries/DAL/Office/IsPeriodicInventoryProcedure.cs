...
namespace MixERP.Net.Schemas.Office.Data
{
	...
	public class IsPeriodicInventoryProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "is_periodic_inventory";
        /// <summary>
		...
		public bool Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"IsPeriodicInventoryProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM office.is_periodic_inventory(@0::integer);";
