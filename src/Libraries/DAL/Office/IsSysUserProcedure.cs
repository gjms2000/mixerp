...
namespace MixERP.Net.Schemas.Office.Data
{
	...
	public class IsSysUserProcedure: DbAccess
	{
        ...
        /// </summary>
	    public override string ObjectName => "is_sys_user";
        /// <summary>
		...
		public bool Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"IsSysUserProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
