...
{
    /// <summary>
    /// Provides simplified data access features to perform SCRUD operation on the database table "office.user_view".
    /// </summary>
    public class UserView : DbAccess
    {
        ...
        /// <summary>
        /// The schema unqualified name of this table. Returns literal "user_view".
        /// </summary>
        ...
        /// <summary>
		/// Performs a filtered select statement on table "office.user_view" producing a paged result of 25.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
