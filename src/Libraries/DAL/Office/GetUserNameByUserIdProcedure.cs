...
namespace MixERP.Net.Schemas.Office.Data
{
	...
	/// </summary>
	public class GetUserNameByUserIdProcedure: DbAccess
	{
        /// <summary>
        ...
        /// </summary>
	    public override string ObjectName => "get_user_name_by_user_id";
        /// <summary>
		...
		public string Execute()
		{
			if (!this.SkipValidation)
			{
				...
				if (!this.HasAccess)
				{
                    Log.Information("Access to the function \"GetUserNameByUserIdProcedure\" was denied to the user with Login ID {LoginId}.", this.LoginId);
					throw new UnauthorizedException("Access is denied.");
				}
			}
			const string query = "SELECT * FROM office.get_user_name_by_user_id(@0::integer);";
			return Factory.Scalar<string>(this.Catalog, query, this.UserId);
		} 
	}
}