...
namespace MixERP.Net.Schemas.Policy.Data
{
    ...
    public class HttpAction : DbAccess
    {
        ...
        /// <summary>
        /// Performs a select statement on table "policy.http_actions" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "policy.http_actions" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "HttpAction" class.</returns>
