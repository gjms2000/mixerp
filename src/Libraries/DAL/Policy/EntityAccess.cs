...
namespace MixERP.Net.Schemas.Policy.Data
{
    ...
    public class EntityAccess : DbAccess
    {
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public object AddOrEdit(MixERP.Net.Entities.Policy.EntityAccess entityAccess, List<EntityParser.CustomField> customFields)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
            ...
            entityAccess.AuditUserId = this._UserId;
        ...
        public object Add(MixERP.Net.Entities.Policy.EntityAccess entityAccess)
        {
            ...
            return Factory.Insert(this._Catalog, entityAccess);
        }
        ...
        public void Update(MixERP.Net.Entities.Policy.EntityAccess entityAccess, int entityAccessId)
        {
            ...
            Factory.Update(this._Catalog, entityAccess, entityAccessId);
        }
        ...
        /// <summary>
        /// Performs a select statement on table "policy.entity_access" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on table "policy.entity_access" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "EntityAccess" class.</returns>
