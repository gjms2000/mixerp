...
*****************************************************************************************************/  
    ...
    FROM core.countries WHERE country_code='EG';

    INSERT INTO core.states(state_code, state_name, country_id)

SELECT ' DK', 'محافظة الدقهلية', _country_id UNION ALL
SELECT ' BA', 'محافظة البحر الاحمر', _country_id UNION ALL
SELECT ' BH', 'محافظة  البحيرة', _country_id UNION ALL
SELECT ' FYM', 'محافظة الفيوم', _country_id UNION ALL
SELECT ' GH', 'محافظة الغربية', _country_id UNION ALL
SELECT ' ALX', 'محافظة الاسكندرية', _country_id UNION ALL
SELECT ' IS', 'محافظة الإسماعيلية', _country_id UNION ALL
SELECT ' GZ', 'محافظة الجيزة', _country_id UNION ALL
SELECT ' MNF', 'محافظة المنوفية', _country_id UNION ALL
SELECT ' MN', 'محافظة المنيا', _country_id UNION ALL
SELECT ' CAI', 'محافظة القاهرة', _country_id UNION ALL
SELECT ' KB', 'محافظة القليوبية', _country_id UNION ALL
SELECT ' LX', 'مدينة الأقصر', _country_id UNION ALL
SELECT ' WAD', 'محافظة الوادي الجديد', _country_id UNION ALL
SELECT ' SHR', 'محافظة الشرقية', _country_id UNION ALL
SELECT ' SUZ', 'محافظة السويس', _country_id UNION ALL
SELECT ' ASN', 'محافظة أسوان', _country_id UNION ALL
SELECT ' AST', 'محافظة أسيوط', _country_id UNION ALL
SELECT ' BNS', 'محافظة بني سويف', _country_id UNION ALL
SELECT ' PTS', 'محافظة بورسعيد', _country_id UNION ALL
SELECT ' DT', 'محافظة دمياط', _country_id UNION ALL
SELECT ' JS', 'محافظة جنوب سيناء', _country_id UNION ALL
SELECT ' KFS', 'محافظة كفر الشيخ', _country_id UNION ALL
SELECT ' MT', 'محافظة مطروح', _country_id UNION ALL
SELECT ' KN', 'محافظة قنا', _country_id UNION ALL
SELECT ' SIN', 'محافظة شمال سيناء', _country_id UNION ALL
SELECT ' SHG', 'محافظة سوهاج', _country_id;


 INSERT INTO core.counties(county_code, county_name, state_id) VALUES
('100101', 'الإسماعيلية', core.get_state_id_by_state_name('محافظة الإسماعيلية')),
('100102', 'التل الكبير', core.get_state_id_by_state_name('محافظة الإسماعيلية')),
('100103', 'فايد', core.get_state_id_by_state_name('محافظة الإسماعيلية')),
('100104', 'القنطرة شرق', core.get_state_id_by_state_name('محافظة الإسماعيلية')),
('100105', 'القنطرة غرب', core.get_state_id_by_state_name('محافظة الإسماعيلية')),
('100106', 'أبو صوير', core.get_state_id_by_state_name('محافظة الإسماعيلية')),
('100107', 'القصاصين', core.get_state_id_by_state_name('محافظة الإسماعيلية')),
('100201', 'أسوان', core.get_state_id_by_state_name('محافظة أسوان')),
('100202', 'إدفو', core.get_state_id_by_state_name('محافظة أسوان')),
('100203', 'كوم امبو', core.get_state_id_by_state_name('محافظة أسوان')),
('100204', 'دراو', core.get_state_id_by_state_name('محافظة أسوان')),
('100205', 'نصر النوبة', core.get_state_id_by_state_name('محافظة أسوان')),
('100301', 'الحمام', core.get_state_id_by_state_name('محافظة مطروح')),
('100302', 'العلمين', core.get_state_id_by_state_name('محافظة مطروح')),
('100303', 'الضبعة', core.get_state_id_by_state_name('محافظة مطروح')),
('100304', 'مرسى مطروح', core.get_state_id_by_state_name('محافظة مطروح')),
('100305', 'النجيلة', core.get_state_id_by_state_name('محافظة مطروح')),
('100306', 'براني', core.get_state_id_by_state_name('محافظة مطروح')),
('100307', 'السلوم', core.get_state_id_by_state_name('محافظة مطروح')),
('100308', 'سيوة', core.get_state_id_by_state_name('محافظة مطروح')),
('100401', 'أسيوط', core.get_state_id_by_state_name('محافظة أسيوط')),
('100402', 'ديروط', core.get_state_id_by_state_name('محافظة أسيوط')),
('100403', 'قوصية', core.get_state_id_by_state_name('محافظة أسيوط')),
('100404', 'أبنوب', core.get_state_id_by_state_name('محافظة أسيوط')),
('100405', 'منفلوط', core.get_state_id_by_state_name('محافظة أسيوط')),
('100406', 'أبو تيج', core.get_state_id_by_state_name('محافظة أسيوط')),
('100407', 'الغنايم', core.get_state_id_by_state_name('محافظة أسيوط')),
('100408', 'ساحل سليم', core.get_state_id_by_state_name('محافظة أسيوط')),
('100409', 'البداري', core.get_state_id_by_state_name('محافظة أسيوط')),
('100410', 'صدفا', core.get_state_id_by_state_name('محافظة أسيوط')),
('100411', 'الفتح', core.get_state_id_by_state_name('محافظة أسيوط')),
('100501', 'الغردقة', core.get_state_id_by_state_name('محافظة البحر الاحمر')),
('100502', 'سفاجا', core.get_state_id_by_state_name('محافظة البحر الاحمر')),
('100503', 'مرسى علم', core.get_state_id_by_state_name('محافظة البحر الاحمر')),
('100504', 'القصير', core.get_state_id_by_state_name('محافظة البحر الاحمر')),
('100505', 'راس غارب', core.get_state_id_by_state_name('محافظة البحر الاحمر')),
('100506', 'شلاتين', core.get_state_id_by_state_name('محافظة البحر الاحمر')),
('100601', 'رشيد', core.get_state_id_by_state_name('محافظة  البحيرة')),
('100602', 'شبراخيت', core.get_state_id_by_state_name('محافظة  البحيرة')),
('100603', 'ايتاي البارود', core.get_state_id_by_state_name('محافظة  البحيرة')),
('100604', 'أبو حمص', core.get_state_id_by_state_name('محافظة  البحيرة')),
('100605', 'كفر الدوار', core.get_state_id_by_state_name('محافظة  البحيرة')),
('100606', 'الدلنجات', core.get_state_id_by_state_name('محافظة  البحيرة')),
('100607', 'كوم حمادة', core.get_state_id_by_state_name('محافظة  البحيرة')),
('100608', 'حوش عيسى', core.get_state_id_by_state_name('محافظة  البحيرة')),
('100609', 'دمنهور', core.get_state_id_by_state_name('محافظة  البحيرة')),
('100610', 'المحمودية', core.get_state_id_by_state_name('محافظة  البحيرة')),
('100611', 'إدكو', core.get_state_id_by_state_name('محافظة  البحيرة')),
('100612', 'أبو المطامير', core.get_state_id_by_state_name('محافظة  البحيرة')),
('100613', 'الرحمانية', core.get_state_id_by_state_name('محافظة  البحيرة')),
('100614', 'النوبارية الجديدة', core.get_state_id_by_state_name('محافظة  البحيرة')),
('100615', 'وادي النطرون', core.get_state_id_by_state_name('محافظة  البحيرة')),
('100701', 'بني سويف', core.get_state_id_by_state_name('محافظة بني سويف')),
('100702', 'مدينة ناصر', core.get_state_id_by_state_name('محافظة بني سويف')),
('100703', 'الفشن', core.get_state_id_by_state_name('محافظة بني سويف')),
('100704', 'ببا', core.get_state_id_by_state_name('محافظة بني سويف')),
('100705', 'اهناسيا', core.get_state_id_by_state_name('محافظة بني سويف')),
('100706', 'الواسطى', core.get_state_id_by_state_name('محافظة بني سويف')),
('100707', 'سمسطا', core.get_state_id_by_state_name('محافظة بني سويف')),
('100801', 'مركز الجيزة', core.get_state_id_by_state_name('محافظة الجيزة')),
('100802', 'الدقي', core.get_state_id_by_state_name('محافظة الجيزة')),
('100803', 'المهندسين', core.get_state_id_by_state_name('محافظة الجيزة')),
('100804', 'امبابة', core.get_state_id_by_state_name('محافظة الجيزة')),
('100805', 'حي فيصل', core.get_state_id_by_state_name('محافظة الجيزة')),
('100806', 'حي الهرم', core.get_state_id_by_state_name('محافظة الجيزة')),
('100807', 'البدرشين', core.get_state_id_by_state_name('محافظة الجيزة')),
('100808', 'العياط', core.get_state_id_by_state_name('محافظة الجيزة')),
('100809', 'اطفيح', core.get_state_id_by_state_name('محافظة الجيزة')),
('100810', 'الواحات البحرية', core.get_state_id_by_state_name('محافظة الجيزة')),
('100811', 'الصف', core.get_state_id_by_state_name('محافظة الجيزة')),
('100812', 'اكتوبر', core.get_state_id_by_state_name('محافظة الجيزة')),
('100901', 'المنزلة', core.get_state_id_by_state_name('محافظة الدقهلية')),
('100902', 'الجمالية', core.get_state_id_by_state_name('محافظة الدقهلية')),
('100903', 'دكرنس', core.get_state_id_by_state_name('محافظة الدقهلية')),
('100904', 'ميت غمر', core.get_state_id_by_state_name('محافظة الدقهلية')),
('100905', 'جمصة', core.get_state_id_by_state_name('محافظة الدقهلية')),
('100906', 'أجا', core.get_state_id_by_state_name('محافظة الدقهلية')),
('100907', 'بلقاس', core.get_state_id_by_state_name('محافظة الدقهلية')),
('100908', 'السنبلاوين', core.get_state_id_by_state_name('محافظة الدقهلية')),
('100909', 'شربين', core.get_state_id_by_state_name('محافظة الدقهلية')),
('100910', 'طلخا', core.get_state_id_by_state_name('محافظة الدقهلية')),
('100911', 'المنصورة', core.get_state_id_by_state_name('محافظة الدقهلية')),
('100912', 'منية النصر', core.get_state_id_by_state_name('محافظة الدقهلية')),
('100913', 'بنى عبيد', core.get_state_id_by_state_name('محافظة الدقهلية')),
('100914', 'ميت سلسيل', core.get_state_id_by_state_name('محافظة الدقهلية')),
('100915', 'برمبال القديمة', core.get_state_id_by_state_name('محافظة الدقهلية')),
('100916', 'تمى الأمديد', core.get_state_id_by_state_name('محافظة الدقهلية')),
('100917', 'المطرية', core.get_state_id_by_state_name('محافظة الدقهلية')),
('100918', 'نبروه', core.get_state_id_by_state_name('محافظة الدقهلية')),
('101001', 'دمياط', core.get_state_id_by_state_name('محافظة دمياط')),
('101002', 'كفر سعد', core.get_state_id_by_state_name('محافظة دمياط')),
('101003', 'فارسكور', core.get_state_id_by_state_name('محافظة دمياط')),
('101004', 'الزرقا', core.get_state_id_by_state_name('محافظة دمياط')),
('101101', 'أخميم', core.get_state_id_by_state_name('محافظة سوهاج')),
('101102', 'البلينا', core.get_state_id_by_state_name('محافظة سوهاج')),
('101103', 'جرجا', core.get_state_id_by_state_name('محافظة سوهاج')),
('101104', 'دار السلام', core.get_state_id_by_state_name('محافظة سوهاج')),
('101105', 'جهينة', core.get_state_id_by_state_name('محافظة سوهاج')),
('101106', 'ساقلتة', core.get_state_id_by_state_name('محافظة سوهاج')),
('101107', 'سوهاج', core.get_state_id_by_state_name('محافظة سوهاج')),
('101108', 'طما', core.get_state_id_by_state_name('محافظة سوهاج')),
('101109', 'طهطا', core.get_state_id_by_state_name('محافظة سوهاج')),
('101110', 'المراغة', core.get_state_id_by_state_name('محافظة سوهاج')),
('101111', 'المنشاة', core.get_state_id_by_state_name('محافظة سوهاج')),
('101201', 'أبو تشت', core.get_state_id_by_state_name('محافظة قنا')),
('101202', 'فرشوط', core.get_state_id_by_state_name('محافظة قنا')),
('101203', 'نجع حمادي', core.get_state_id_by_state_name('محافظة قنا')),
('101204', 'الوقف', core.get_state_id_by_state_name('محافظة قنا')),
('101205', 'دشنا', core.get_state_id_by_state_name('محافظة قنا')),
('101206', 'قنا', core.get_state_id_by_state_name('محافظة قنا')),
('101207', 'قفط', core.get_state_id_by_state_name('محافظة قنا')),
('101208', 'قوص', core.get_state_id_by_state_name('محافظة قنا')),
('101209', 'نقادة', core.get_state_id_by_state_name('محافظة قنا')),
('101301', 'السويس', core.get_state_id_by_state_name('محافظة السويس')),
('101302', 'الأربعين', core.get_state_id_by_state_name('محافظة السويس')),
('101303', 'عتاقة', core.get_state_id_by_state_name('محافظة السويس')),
('101304', 'الجناين', core.get_state_id_by_state_name('محافظة السويس')),
('101304', 'العين السخنة', core.get_state_id_by_state_name('محافظة السويس')),
('101401', 'أبو حماد', core.get_state_id_by_state_name('محافظة الشرقية')),
('101402', 'أبو كبير', core.get_state_id_by_state_name('محافظة الشرقية')),
('101403', 'أولاد صقر', core.get_state_id_by_state_name('محافظة الشرقية')),
('101404', 'بلبيس', core.get_state_id_by_state_name('محافظة الشرقية')),
('101405', 'الحسينية', core.get_state_id_by_state_name('محافظة الشرقية')),
('101406', 'ديرب نجم', core.get_state_id_by_state_name('محافظة الشرقية')),
('101407', 'الزقازيق', core.get_state_id_by_state_name('محافظة الشرقية')),
('101408', 'الصالحية', core.get_state_id_by_state_name('محافظة الشرقية')),
('101409', 'العاشر من رمضان', core.get_state_id_by_state_name('محافظة الشرقية')),
('101410', 'فاقوس', core.get_state_id_by_state_name('محافظة الشرقية')),
('101411', 'كفر صقر', core.get_state_id_by_state_name('محافظة الشرقية')),
('101412', 'منيا القمح', core.get_state_id_by_state_name('محافظة الشرقية')),
('101413', 'ههيا', core.get_state_id_by_state_name('محافظة الشرقية')),
('101414', 'مشتول السوق', core.get_state_id_by_state_name('محافظة الشرقية')),
('101415', 'الإبراهيمية', core.get_state_id_by_state_name('محافظة الشرقية')),
('101501', 'طابا', core.get_state_id_by_state_name('محافظة جنوب سيناء')),
('101502', 'نويبع', core.get_state_id_by_state_name('محافظة جنوب سيناء')),
('101503', 'دهب', core.get_state_id_by_state_name('محافظة جنوب سيناء')),
('101504', 'الطور', core.get_state_id_by_state_name('محافظة جنوب سيناء')),
('101505', 'رأس سدر', core.get_state_id_by_state_name('محافظة جنوب سيناء')),
('101506', 'شرم الشيخ', core.get_state_id_by_state_name('محافظة جنوب سيناء')),
('101601', 'المحلة الكبرى - حي أول', core.get_state_id_by_state_name('محافظة الغربية')),
('101602', 'المحلة الكبرى - حي ثاني', core.get_state_id_by_state_name('محافظة الغربية')),
('101603', 'طنطا - حي أول', core.get_state_id_by_state_name('محافظة الغربية')),
('101604', 'طنطا - حي ثاني', core.get_state_id_by_state_name('محافظة الغربية')),
('101605', 'سمنود', core.get_state_id_by_state_name('محافظة الغربية')),
('101606', 'قطور', core.get_state_id_by_state_name('محافظة الغربية')),
('101607', 'السنطة', core.get_state_id_by_state_name('محافظة الغربية')),
('101608', 'زفتى', core.get_state_id_by_state_name('محافظة الغربية')),
('101609', 'بسيون', core.get_state_id_by_state_name('محافظة الغربية')),
('101610', 'كفر الزيات', core.get_state_id_by_state_name('محافظة الغربية')),
('101701', 'أبشواي', core.get_state_id_by_state_name('محافظة الفيوم')),
('101702', 'أطسا', core.get_state_id_by_state_name('محافظة الفيوم')),
('101703', 'الفيوم', core.get_state_id_by_state_name('محافظة الفيوم')),
('101704', 'سنورس', core.get_state_id_by_state_name('محافظة الفيوم')),
('101705', 'طامية', core.get_state_id_by_state_name('محافظة الفيوم')),
('101801', 'النزهة', core.get_state_id_by_state_name('محافظة القاهرة')),
('101802', 'مصر الجديدة', core.get_state_id_by_state_name('محافظة القاهرة')),
('101803', 'مدينة نصر - حي شرق', core.get_state_id_by_state_name('محافظة القاهرة')),
('101804', 'مدينة نصر - حي غرب', core.get_state_id_by_state_name('محافظة القاهرة')),
('101805', 'المعادي', core.get_state_id_by_state_name('محافظة القاهرة')),
('101806', 'الوايلي', core.get_state_id_by_state_name('محافظة القاهرة')),
('101807', 'الزيتون', core.get_state_id_by_state_name('محافظة القاهرة')),
('101808', 'عابدين', core.get_state_id_by_state_name('محافظة القاهرة')),
('101809', 'غرب القاهرة', core.get_state_id_by_state_name('محافظة القاهرة')),
('101810', 'البساتين ودار السلام', core.get_state_id_by_state_name('محافظة القاهرة')),
('101811', 'المطرية', core.get_state_id_by_state_name('محافظة القاهرة')),
('101812', 'عين شمس', core.get_state_id_by_state_name('محافظة القاهرة')),
('101813', 'السلام', core.get_state_id_by_state_name('محافظة القاهرة')),
('101814', 'الساحل', core.get_state_id_by_state_name('محافظة القاهرة')),
('101815', 'الزاوية الحمراء', core.get_state_id_by_state_name('محافظة القاهرة')),
('101816', 'حدائق القبة', core.get_state_id_by_state_name('محافظة القاهرة')),
('101817', 'المرج', core.get_state_id_by_state_name('محافظة القاهرة')),
('101818', 'الشرابية', core.get_state_id_by_state_name('محافظة القاهرة')),
('101819', 'مصر القديمة', core.get_state_id_by_state_name('محافظة القاهرة')),
('101820', 'الخليفة والمقطم', core.get_state_id_by_state_name('محافظة القاهرة')),
('101821', 'روض الفرج', core.get_state_id_by_state_name('محافظة القاهرة')),
('101822', 'منشأة ناصر', core.get_state_id_by_state_name('محافظة القاهرة')),
('101823', 'السيدة زينب', core.get_state_id_by_state_name('محافظة القاهرة')),
('101824', 'وسط القاهرة', core.get_state_id_by_state_name('محافظة القاهرة')),
('101825', 'التبين', core.get_state_id_by_state_name('محافظة القاهرة')),
('101826', 'باب الشعرية', core.get_state_id_by_state_name('محافظة القاهرة')),
('101827', 'الموسكي', core.get_state_id_by_state_name('محافظة القاهرة')),
('101828', 'شبرا', core.get_state_id_by_state_name('محافظة القاهرة')),
('101829', 'حلوان', core.get_state_id_by_state_name('محافظة القاهرة')),
('101830', 'مدينة 15 مايو', core.get_state_id_by_state_name('محافظة القاهرة')),
('101831', 'القاهرة الجديدة', core.get_state_id_by_state_name('محافظة القاهرة')),
('101832', 'الشروق', core.get_state_id_by_state_name('محافظة القاهرة')),
('101833', 'مدينة بدر', core.get_state_id_by_state_name('محافظة القاهرة')),
('101834', 'مدينة النهضة', core.get_state_id_by_state_name('محافظة القاهرة')),
('101835', 'مدينة السلام', core.get_state_id_by_state_name('محافظة القاهرة')),
('101836', 'جسر السويس', core.get_state_id_by_state_name('محافظة القاهرة')),
('101901', 'بنها', core.get_state_id_by_state_name('محافظة القليوبية')),
('101902', 'قليوب', core.get_state_id_by_state_name('محافظة القليوبية')),
('101903', 'القناطر الخيرية', core.get_state_id_by_state_name('محافظة القليوبية')),
('101904', 'شبرا الخيمة', core.get_state_id_by_state_name('محافظة القليوبية')),
('101905', 'الخانكة', core.get_state_id_by_state_name('محافظة القليوبية')),
('101906', 'كفر شكر', core.get_state_id_by_state_name('محافظة القليوبية')),
('101907', 'شبين القناطر', core.get_state_id_by_state_name('محافظة القليوبية')),
('101908', 'طوخ', core.get_state_id_by_state_name('محافظة القليوبية')),
('102001', 'كفرالشيخ', core.get_state_id_by_state_name('محافظة كفر الشيخ')),
('102002', 'دسوق', core.get_state_id_by_state_name('محافظة كفر الشيخ')),
('102003', 'بيلا', core.get_state_id_by_state_name('محافظة كفر الشيخ')),
('102004', 'قلين', core.get_state_id_by_state_name('محافظة كفر الشيخ')),
('102005', 'مطوبس', core.get_state_id_by_state_name('محافظة كفر الشيخ')),
('102006', 'الحامول', core.get_state_id_by_state_name('محافظة كفر الشيخ')),
('102007', 'البرلس', core.get_state_id_by_state_name('محافظة كفر الشيخ')),
('102008', 'سيدي سالم', core.get_state_id_by_state_name('محافظة كفر الشيخ')),
('102009', 'الرياض', core.get_state_id_by_state_name('محافظة كفر الشيخ')),
('102010', 'فوه', core.get_state_id_by_state_name('محافظة كفر الشيخ')),
('102101', 'أشمون', core.get_state_id_by_state_name('محافظة المنوفية')),
('102102', 'الباجور', core.get_state_id_by_state_name('محافظة المنوفية')),
('102103', 'بركة السبع', core.get_state_id_by_state_name('محافظة المنوفية')),
('102104', 'منوف', core.get_state_id_by_state_name('محافظة المنوفية')),
('102105', 'مدينة السادات', core.get_state_id_by_state_name('محافظة المنوفية')),
('102106', 'سرس الليان', core.get_state_id_by_state_name('محافظة المنوفية')),
('102107', 'تلا', core.get_state_id_by_state_name('محافظة المنوفية')),
('102108', 'الشهداء', core.get_state_id_by_state_name('محافظة المنوفية')),
('102109', 'شبين الكوم', core.get_state_id_by_state_name('محافظة المنوفية')),
('102110', 'قويسنا', core.get_state_id_by_state_name('محافظة المنوفية')),
('102201', 'أبو قرقاص', core.get_state_id_by_state_name('محافظة المنيا')),
('102202', 'بني مزار', core.get_state_id_by_state_name('محافظة المنيا')),
('102203', 'دير مواس', core.get_state_id_by_state_name('محافظة المنيا')),
('102204', 'سمالوط', core.get_state_id_by_state_name('محافظة المنيا')),
('102205', 'العدوة', core.get_state_id_by_state_name('محافظة المنيا')),
('102206', 'مطاي', core.get_state_id_by_state_name('محافظة المنيا')),
('102207', 'مغاغة', core.get_state_id_by_state_name('محافظة المنيا')),
('102208', 'ملوي', core.get_state_id_by_state_name('محافظة المنيا')),
('102209', 'المنيا', core.get_state_id_by_state_name('محافظة المنيا')),
('102210', 'المنيا الجديدة', core.get_state_id_by_state_name('محافظة المنيا')),
('102301', 'الداخلة', core.get_state_id_by_state_name('محافظة الوادي الجديد')),
('102302', 'الخارجة', core.get_state_id_by_state_name('محافظة الوادي الجديد')),
('102303', 'الفرافرة', core.get_state_id_by_state_name('محافظة الوادي الجديد')),
('102401', 'الأقصر', core.get_state_id_by_state_name('مدينة الأقصر')),
('102402', 'البياضية', core.get_state_id_by_state_name('مدينة الأقصر')),
('102403', 'الزينية', core.get_state_id_by_state_name('مدينة الأقصر')),
('102404', 'مركز الطود', core.get_state_id_by_state_name('مدينة الأقصر')),
('102405', 'مركز القرنة', core.get_state_id_by_state_name('مدينة الأقصر')),
('102406', 'مركز أرمنت', core.get_state_id_by_state_name('مدينة الأقصر')),
('102407', 'مركز إسنا ', core.get_state_id_by_state_name('مدينة الأقصر')),
('102501', 'حي المنتزه', core.get_state_id_by_state_name('محافظة الاسكندرية')),
('102502', 'حي شرق الإسكندرية', core.get_state_id_by_state_name('محافظة الاسكندرية')),
('102503', 'حي وسط الإسكندرية', core.get_state_id_by_state_name('محافظة الاسكندرية')),
('102504', 'حي الجمرك', core.get_state_id_by_state_name('محافظة الاسكندرية')),
('102505', 'العجمي (الإسكندرية)', core.get_state_id_by_state_name('محافظة الاسكندرية')),
('102506', 'حي العامرية', core.get_state_id_by_state_name('محافظة الاسكندرية')),
('102507', 'مدينة برج العرب', core.get_state_id_by_state_name('محافظة الاسكندرية')),
('102601', ' حي الشرق', core.get_state_id_by_state_name('محافظة بورسعيد')),
('102602', ' حي العرب', core.get_state_id_by_state_name('محافظة بورسعيد')),
('102603', ' حي المناخ', core.get_state_id_by_state_name('محافظة بورسعيد')),
('102604', 'حي الضواحي', core.get_state_id_by_state_name('محافظة بورسعيد')),
('102605', 'حي الجنوب', core.get_state_id_by_state_name('محافظة بورسعيد')),
('102606', ' حي الزهور', core.get_state_id_by_state_name('محافظة بورسعيد')),
('102607', ' مدينة بورفؤاد', core.get_state_id_by_state_name('محافظة بورسعيد')),
('102701', 'بئر العبد', core.get_state_id_by_state_name('محافظة شمال سيناء')),
('102702', 'نخل', core.get_state_id_by_state_name('محافظة شمال سيناء')),
('102703', 'الحسنة', core.get_state_id_by_state_name('محافظة شمال سيناء')),
('102704', 'العريش', core.get_state_id_by_state_name('محافظة شمال سيناء')),
('102705', 'الشيخ زويد', core.get_state_id_by_state_name('محافظة شمال سيناء')),
('102706', 'رفح', core.get_state_id_by_state_name('محافظة شمال سيناء'));
