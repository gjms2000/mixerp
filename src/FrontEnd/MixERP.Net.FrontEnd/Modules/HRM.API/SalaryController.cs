...
namespace MixERP.Net.Api.HRM
{
    ...
    public class SalaryController : ApiController
    {
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 salaries on each page, sorted by the property SalaryId.
        /// </summary>
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 salaries on each page, sorted by the property SalaryId.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.HRM.Salary> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
        ...
        public object AddOrEdit([FromBody]Newtonsoft.Json.Linq.JArray form)
        {
            ...
            try
            {
                return this.SalaryContext.AddOrEdit(salary, customFields);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
