...
namespace MixERP.Net.Api.HRM
{
    ...
    public class EmployeeSocialNetworkDetailController : ApiController
    {
        ...
        public void AddOrEdit([FromBody]MixERP.Net.Entities.HRM.EmployeeSocialNetworkDetail employeeSocialNetworkDetail)
        {
            ...
            try
            {
                this.EmployeeSocialNetworkDetailContext.AddOrEdit(employeeSocialNetworkDetail);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
