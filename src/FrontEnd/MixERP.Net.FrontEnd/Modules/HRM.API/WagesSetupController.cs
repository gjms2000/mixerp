...
namespace MixERP.Net.Api.HRM
{
    ...
    public class WagesSetupController : ApiController
    {
        ...
        /// <summary>
        ///     Creates a paginated collection containing 10 wages setups on each page, sorted by the property WagesSetupId.
        /// </summary>
        ...
        /// <summary>
        ///     Creates a filtered and paginated collection containing 10 wages setups on each page, sorted by the property WagesSetupId.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the resultset.</param>
        /// <param name="filters">The list of filter conditions.</param>
        ...
        public IEnumerable<MixERP.Net.Entities.HRM.WagesSetup> GetWhere(long pageNumber, [FromBody]JArray filters)
        {
            try
            {
                List<EntityParser.Filter> f = filters.ToObject<List<EntityParser.Filter>>(JsonHelper.GetJsonSerializer());
        ...
        public object AddOrEdit([FromBody]Newtonsoft.Json.Linq.JArray form)
        {
            ...
            try
            {
                return this.WagesSetupContext.AddOrEdit(wagesSetup, customFields);
            }
            catch (UnauthorizedException)
            {
                throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.Forbidden));
