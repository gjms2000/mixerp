...
namespace MixERP.Net.Core.Modules.HRM.Data
{
    public class Resignation
    {
		...
		public MixERP.Net.Entities.HRM.Resignation Get(string catalog, int resignationId)
		{
			const string sql = "SELECT * FROM hrm.resignations WHERE resignation_id=@0;";
			return Factory.Get<MixERP.Net.Entities.HRM.Resignation>(catalog, sql, resignationId).FirstOrDefault();
		}
		...
		public void Add(string catalog, MixERP.Net.Entities.HRM.Resignation resignation)
		{
			Factory.Insert(catalog, resignation);
		}
		...
		public void Update(string catalog, MixERP.Net.Entities.HRM.Resignation resignation, int resignationId)
		{
			Factory.Update(catalog, resignation, resignationId);
		}
		...
		public void Delete(string catalog, int resignationId)
		{
			const string sql = "DELETE FROM hrm.resignations WHERE resignation_id=@0;";
			Factory.NonQuery(catalog, sql, resignationId);
		}
		...
		public IEnumerable<MixERP.Net.Entities.HRM.Resignation> GetPagedResult(string catalog)
		{
			const string sql = "SELECT * FROM hrm.resignations ORDER BY resignation_id LIMIT 10 OFFSET 0;";
			return Factory.Get<MixERP.Net.Entities.HRM.Resignation>(catalog, sql);
		}
		...
		public IEnumerable<MixERP.Net.Entities.HRM.Resignation> GetPagedResult(string catalog, long pageNumber)
		{
			long offset = (pageNumber -1) * 10;
			const string sql = "SELECT * FROM hrm.resignations ORDER BY resignation_id LIMIT 10 OFFSET @0;";
				
			return Factory.Get<MixERP.Net.Entities.HRM.Resignation>(catalog, sql, offset);
		}
	}
}