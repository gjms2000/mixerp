...
namespace MixERP.Net.Core.Modules.HRM.Data
{
    ...
    public class Resignation : DbAccess
    {
        ...
        public IEnumerable<PetaPoco.CustomField> GetCustomFields()
        {
            ...
            const string sql = "SELECT * FROM core.custom_field_definition_view WHERE table_name='hrm.resignations' ORDER BY field_order;";
		...
		public void Add(MixERP.Net.Entities.HRM.Resignation resignation)
		{
			...
			Factory.Insert(this.Catalog, resignation);
		}
