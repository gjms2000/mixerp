...
namespace MixERP.Net.Core.Modules.HRM.Data
{
    ...
    public class EmployeeSocialNetworkDetailScrudView : DbAccess
    {
        ...
        /// <summary>
        /// Performs a select statement on the view "hrm.employee_social_network_detail_scrud_view" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on view "hrm.employee_social_network_detail_scrud_view" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "EmployeeSocialNetworkDetailScrudView" class.</returns>
