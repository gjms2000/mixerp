...
{
    /// <summary>
    /// Provides simplified data access features to perform SCRUD operation on the database table "hrm.employee_social_network_detail_scrud_view".
    /// </summary>
    public class EmployeeSocialNetworkDetailScrudView : DbAccess
    {
        ...
        /// <summary>
        /// The schema unqualified name of this table. Returns literal "employee_social_network_detail_scrud_view".
        /// </summary>
		...
		/// <summary>
		/// Performs SQL count on the table "hrm.employee_social_network_detail_scrud_view".
		/// </summary>
		/// <returns>Returns the number of rows of the table "hrm.employee_social_network_detail_scrud_view".</returns>
		...
		/// <summary>
		/// Performs a select statement on table "hrm.employee_social_network_detail_scrud_view" producing a paged result of 25.
		/// </summary>
        ...
        /// <summary>
		/// Performs a filtered select statement on table "hrm.employee_social_network_detail_scrud_view" producing a paged result of 25.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
