...
namespace MixERP.Net.Core.Modules.HRM.Data
{
    ...
    public class EmployeeQualificationScrudView : DbAccess
    {
        ...
        /// <summary>
        /// Performs a select statement on the view "hrm.employee_qualification_scrud_view" producing a paged result of 10.
        /// </summary>
        ...
        /// <summary>
        /// Performs a filtered select statement on view "hrm.employee_qualification_scrud_view" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "EmployeeQualificationScrudView" class.</returns>
