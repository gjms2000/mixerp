...
namespace MixERP.Net.Core.Modules.HRM.Data
{
    ...
    public class Contract : DbAccess
    {
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public object AddOrEdit(MixERP.Net.Entities.HRM.Contract contract, List<EntityParser.CustomField> customFields)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
            ...
            contract.AuditUserId = this._UserId;
        ...
        public object Add(MixERP.Net.Entities.HRM.Contract contract)
        {
            ...
            return Factory.Insert(this._Catalog, contract);
        }
        ...
        public void Update(MixERP.Net.Entities.HRM.Contract contract, long contractId)
        {
            ...
            Factory.Update(this._Catalog, contract, contractId);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "hrm.contracts" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "Contract" class.</returns>
