...
namespace MixERP.Net.Core.Modules.HRM.Data
{
    ...
    public class PayGrade : DbAccess
    {
        ...
        /// <exception cref="UnauthorizedException">Thown when the application user does not have sufficient privilege to perform this action.</exception>
        public object AddOrEdit(MixERP.Net.Entities.HRM.PayGrade payGrade, List<EntityParser.CustomField> customFields)
        {
            if (string.IsNullOrWhiteSpace(this._Catalog))
            {
                return null;
            ...
            payGrade.AuditUserId = this._UserId;
        ...
        public object Add(MixERP.Net.Entities.HRM.PayGrade payGrade)
        {
            ...
            return Factory.Insert(this._Catalog, payGrade);
        }
        ...
        public void Update(MixERP.Net.Entities.HRM.PayGrade payGrade, int payGradeId)
        {
            ...
            Factory.Update(this._Catalog, payGrade, payGradeId);
        }
        ...
        /// <summary>
        /// Performs a filtered select statement on table "hrm.pay_grades" producing a paged result of 10.
        /// </summary>
        /// <param name="pageNumber">Enter the page number to produce the paged result.</param>
        /// <param name="filters">The list of filter conditions.</param>
        /// <returns>Returns collection of "PayGrade" class.</returns>
