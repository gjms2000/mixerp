...
namespace MixERP.Net.Core.Modules.HRM.Data
{
    public class EmployeeType
    {
		...
		public MixERP.Net.Entities.HRM.EmployeeType Get(string catalog, int employeeTypeId)
		{
			const string sql = "SELECT * FROM hrm.employee_types WHERE employee_type_id=@0;";
			return Factory.Get<MixERP.Net.Entities.HRM.EmployeeType>(catalog, sql, employeeTypeId).FirstOrDefault();
		}
		...
		public void Add(string catalog, MixERP.Net.Entities.HRM.EmployeeType employeeType)
		{
			Factory.Insert(catalog, employeeType);
		}
		...
		public void Update(string catalog, MixERP.Net.Entities.HRM.EmployeeType employeeType, int employeeTypeId)
		{
			Factory.Update(catalog, employeeType, employeeTypeId);
		}
		...
		public void Delete(string catalog, int employeeTypeId)
		{
			const string sql = "DELETE FROM hrm.employee_types WHERE employee_type_id=@0;";
			Factory.NonQuery(catalog, sql, employeeTypeId);
		}
		...
		public IEnumerable<MixERP.Net.Entities.HRM.EmployeeType> GetPagedResult(string catalog)
		{
			const string sql = "SELECT * FROM hrm.employee_types ORDER BY employee_type_id LIMIT 10 OFFSET 0;";
			return Factory.Get<MixERP.Net.Entities.HRM.EmployeeType>(catalog, sql);
		}
		...
		public IEnumerable<MixERP.Net.Entities.HRM.EmployeeType> GetPagedResult(string catalog, long pageNumber)
		{
			long offset = (pageNumber -1) * 10;
			const string sql = "SELECT * FROM hrm.employee_types ORDER BY employee_type_id LIMIT 10 OFFSET @0;";
				
			return Factory.Get<MixERP.Net.Entities.HRM.EmployeeType>(catalog, sql, offset);
		}
	}
}