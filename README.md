...
MixERP maintains 100% backward compatibility which means that the new version you install will safely update your current installation.
...
MixERP is **PostgreSQL-only ERP** and **we will not support** any other DBMS anytime soon in the near future. However, we fully support compatible PostgreSQL forks such as [PostgreSQL Plus Advanced Server](http://www.enterprisedb.com/).
